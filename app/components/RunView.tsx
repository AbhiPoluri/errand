...
// Hover-revealed "Copy" under a reply, with brief "Copied" feedback.
function CopyButton({ text }: { text: string }) {
  ...
  return (
    <button
      ...
      className="mt-2 inline-flex items-center gap-1.5 text-xs font-medium text-stone-400 opacity-0 transition focus:opacity-100 group-hover:opacity-100 hover:text-stone-700"
    >
      {copied ? (
        <>
